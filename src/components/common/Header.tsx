      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' }, textTransform: 'capitalize'  }}>
              <Button  sx={{ color: '#00BDD6', mr: 2, textTransform: 'capitalize'  }}>Login</Button>
              <Button variant="contained"  sx={{ color: 'white', mr: 2, bgcolor: '#00BDD6', textTransform: 'capitalize', borderRadius: 23 }}>Signup</Button>
            </Box>
